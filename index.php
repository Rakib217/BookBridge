        ...
        <section class="product-tabs section-padding wow fadeIn animated">
            <div class="container">
                <div class="tab-header">
                    ...
                    <a href="shop-filter.php" class="view-more d-none d-md-flex">View More<i class="fi-rs-angle-double-small-right"></i></a>
                </div>
                <!--End nav-tabs-->
            ...
            <div class="col-lg-4 col-md-4 col-12 col-sm-6">
                <div class="product-cart-wrap mb-30">
                    <div class="product-img-action-wrap">
                        ...
                        <a href="shop-product.php?book_id=<?php echo $row['book_id']; ?>&cover_img=<?php echo urlencode($row['cover_img']); ?>">
                    ...
                    <div class="product-content-wrap">
                        <div class="product-category">
                            <a href="shop-product.php?book_id=<?php echo $row['book_id']; ?>"><?php echo $row["categoryName"]; ?></a>
                        </div>
