...
if(isset($_GET['search'])) {
    ...
    WHERE book.title LIKE '%$search_term%' OR book.authors LIKE '%$search_term%' OR category.categoryName LIKE '%$search_term%'";
                ...
                <div class="product-cart-wrap mb-30">
                    <div class="product-img-action-wrap">
                        <div class="product-img product-img-zoom">
                            <a href="shop-product.php?book_id=<?php echo $row['book_id']; ?>">
